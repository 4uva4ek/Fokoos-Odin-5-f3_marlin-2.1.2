...
//
  ...
  #define HOTEND0_RESISTANCE_25C_OHMS   100000 /е/ Resistance at 25C
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  52.6          // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  52.6          // (Hz) The default dominant resonant frequency on the Y axis.
